...
PartitionStorageErrorRate            Rate of partition responses returning KAFKA_STORAGE_ERROR from FetchCompleter (missing batch metadata or no records constructable from fetched extents).                                                                                                                                
