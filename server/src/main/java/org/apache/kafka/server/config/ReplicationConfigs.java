...
public class ReplicationConfigs {
    ...
    public static final String MIRROR_NUM_REPLICA_FETCHERS = "mirror.num.replica.fetchers";
    public static final int MIRROR_NUM_REPLICA_FETCHERS_DEFAULT = 1;
    public static final String MIRROR_NUM_REPLICA_FETCHERS_DOC = "Number of fetcher threads used to replicate records from remote clusters via cluster mirror. " +
            "The total number of remote fetchers on each broker is bound by <code>cluster.mirror.num.replica.fetchers</code> multiplied by the number of cluster mirrors. " +
    ...
    public static final ConfigDef CONFIG_DEF =  new ConfigDef()
            ...
            .define(MIRROR_NUM_REPLICA_FETCHERS, INT, MIRROR_NUM_REPLICA_FETCHERS_DEFAULT, atLeast(1), HIGH, MIRROR_NUM_REPLICA_FETCHERS_DOC)
