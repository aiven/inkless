...
public enum ApiKeys {
    ...
    CREATE_VIRTUAL_CLUSTERS(ApiMessageType.CREATE_VIRTUAL_CLUSTERS, false, true),
    ALTER_VIRTUAL_CLUSTERS(ApiMessageType.ALTER_VIRTUAL_CLUSTERS, false, true),
    DELETE_VIRTUAL_CLUSTERS(ApiMessageType.DELETE_VIRTUAL_CLUSTERS, false, true),
    LIST_VIRTUAL_CLUSTERS(ApiMessageType.LIST_VIRTUAL_CLUSTERS, false, true),
    DESCRIBE_VIRTUAL_CLUSTERS(ApiMessageType.DESCRIBE_VIRTUAL_CLUSTERS, false, true),
