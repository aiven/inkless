...
public class InitDisklessLogResponse extends AbstractResponse {

    private final InitDisklessLogResponseData data;

    public InitDisklessLogResponse(InitDisklessLogResponseData data) {
        super(ApiKeys.INIT_DISKLESS_LOG);
        this.data = data;
    }

    @Override
    public InitDisklessLogResponseData data() {
        return data;
    }
