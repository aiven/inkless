...
public class FilesRecord extends UpdatableRecordImpl<FilesRecord> {
     ...
     */
    public FilesRecord(Long fileId, String objectKey, Short format, FileReason reason, FileStateT state, Integer uploaderBrokerId, Instant committedAt, Instant markedForDeletionAt, Long size, Long usedSize) {
        super(Files.FILES);
