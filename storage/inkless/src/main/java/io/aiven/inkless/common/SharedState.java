...
public final class SharedState implements Closeable {
    ...
    public static SharedState initialize(
        ...
        if (config.isBatchCoordinatesCacheEnabled() && config.batchCoordinateCacheTtl().toMillis() > maxTtl.toMillis()) {
        ...
        return new SharedState(
            ...
            config.isBatchCoordinatesCacheEnabled() ? new CaffeineBatchCoordinateCache(config.batchCoordinateCacheTtl()) : new NullBatchCoordinateCache(),
            brokerTopicStats,
            defaultTopicConfigs
        );
    }
    ...
    public boolean isBatchCoordinatesCacheEnabled() {
        return config.isBatchCoordinatesCacheEnabled();
    }
