...
public class ClientAzAwarenessMetrics implements Closeable {
    ...
    private final KafkaMetricsGroup metricsGroup = new KafkaMetricsGroup(ClientAzAwarenessMetrics.class.getPackageName(), ClientAzAwarenessMetrics.class.getSimpleName());
