...
import io.aiven.inkless.delete.TopicPurgerMetrics;
...
public class MetricsDocs {
    public static void main(final String[] args) {
        printDocumentHeading("Diskless metrics");
        ...
        out.println();
        out.println(toRstTable(SharedState.STORAGE_METRIC_CONTEXT, io.aiven.inkless.storage_backend.azure.MetricRegistry.all()));
        ...
        printHeading("TopicPurger metrics");
        out.println();
        out.println(toRstTable("io.aiven.inkless.delete", TopicPurgerMetrics.all()));
