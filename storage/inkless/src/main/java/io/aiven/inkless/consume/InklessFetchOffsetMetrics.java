...
public class InklessFetchOffsetMetrics {
    ...
    private final KafkaMetricsGroup metricsGroup = new KafkaMetricsGroup(InklessFetchOffsetMetrics.class.getPackageName(), InklessFetchOffsetMetrics.class.getSimpleName());
