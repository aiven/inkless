...
public class GetLogInfoJob implements Callable<GetLogInfoResponse> {
    ...
    @Override
    public GetLogInfoResponse call() throws Exception {
        return JobUtils.run(this::runOnce, time, durationCallback);
    }

    private GetLogInfoResponse runOnce() throws Exception {
