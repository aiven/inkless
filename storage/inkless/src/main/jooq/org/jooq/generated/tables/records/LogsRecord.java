...
public class LogsRecord extends UpdatableRecordImpl<LogsRecord> {
    ...
    /**
     * Setter for <code>logs.diskless_end_offset</code>.
     */
    public void setDisklessEndOffset(Long value) {
        set(7, value);
    }

    /**
     * Getter for <code>logs.diskless_end_offset</code>.
     */
    public Long getDisklessEndOffset() {
        return (Long) get(7);
    }

    /**
     * Setter for <code>logs.leader_epoch_at_init</code>.
     */
    public void setLeaderEpochAtInit(Integer value) {
        set(8, value);
    }

    /**
     * Getter for <code>logs.leader_epoch_at_init</code>.
     */
    public Integer getLeaderEpochAtInit() {
     ...
     */
    public LogsRecord(Uuid topicId, Integer partition, String topicName, Long logStartOffset, Long highWatermark, Long byteSize, Long disklessStartOffset, Long disklessEndOffset, Integer leaderEpochAtInit) {
        super(Logs.LOGS);
        ...
        setDisklessEndOffset(disklessEndOffset);
        setLeaderEpochAtInit(leaderEpochAtInit);
