...
public class LogsRecord extends UpdatableRecordImpl<LogsRecord> {
    ...
    /**
     * Setter for <code>logs.consolidated_remote_log_end_offset</code>. Highest
     * offset for this partition that has been copied to tiered storage by the
     * consolidation process. NULL if none yet.
     */
    public void setConsolidatedRemoteLogEndOffset(Long value) {
        set(6, value);
    }

    /**
     * Getter for <code>logs.consolidated_remote_log_end_offset</code>. Highest
     * offset for this partition that has been copied to tiered storage by the
     * consolidation process. NULL if none yet.
     */
    public Long getConsolidatedRemoteLogEndOffset() {
        return (Long) get(6);
    }
     ...
     */
    public LogsRecord(Uuid topicId, Integer partition, String topicName, Long logStartOffset, Long highWatermark, Long byteSize, Long consolidatedRemoteLogEndOffset) {
        super(Logs.LOGS);
        ...
        setConsolidatedRemoteLogEndOffset(consolidatedRemoteLogEndOffset);
