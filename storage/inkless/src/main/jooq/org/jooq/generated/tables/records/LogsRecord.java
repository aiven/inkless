...
public class LogsRecord extends UpdatableRecordImpl<LogsRecord> {
    ...
    /**
     * Setter for <code>logs.diskless_start_offset</code>.
     */
    ...
    /**
     * Getter for <code>logs.diskless_start_offset</code>.
     */
    ...
    /**
     * Setter for <code>logs.remote_log_start_offset</code>.
     */
    ...
    /**
     * Getter for <code>logs.remote_log_start_offset</code>.
     */
    ...
    /**
     * Setter for <code>logs.earliest_batch_timestamp</code>.
     */
    public void setEarliestBatchTimestamp(Long value) {
        set(8, value);
    }

    /**
     * Getter for <code>logs.earliest_batch_timestamp</code>.
     */
    public Long getEarliestBatchTimestamp() {
        return (Long) get(8);
    }

    /**
     * Setter for <code>logs.deleted_at</code>.
     */
    ...
    /**
     * Getter for <code>logs.deleted_at</code>.
     */
     ...
     */
    public LogsRecord(Uuid topicId, Integer partition, String topicName, Long logStartOffset, Long highWatermark, Long byteSize, Long disklessStartOffset, Long remoteLogStartOffset, Long earliestBatchTimestamp, Instant deletedAt) {
        super(Logs.LOGS);
        ...
        setEarliestBatchTimestamp(earliestBatchTimestamp);
