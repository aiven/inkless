...
public class LogsRecord extends UpdatableRecordImpl<LogsRecord> {
     ...
     */
    public LogsRecord(Uuid topicId, Integer partition, String topicName, Long logStartOffset, Long highWatermark, Long byteSize, Long disklessStartOffset, Long remoteLogStartOffset, Long earliestBatchTimestamp) {
        super(Logs.LOGS);
