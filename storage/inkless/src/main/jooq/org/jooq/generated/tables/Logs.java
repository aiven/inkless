...
public class Logs extends TableImpl<LogsRecord> {
    ...
    /**
     * The column <code>logs.diskless_start_offset</code>.
     */
    public final TableField<LogsRecord, Long> DISKLESS_START_OFFSET = createField(DSL.name("diskless_start_offset"), Domains.OFFSET_T.getDataType().defaultValue(DSL.field(DSL.raw("0"), Domains.OFFSET_T.getDataType())), this, "");

    /**
     * The column <code>logs.remote_log_start_offset</code>.
     */
    public final TableField<LogsRecord, Long> REMOTE_LOG_START_OFFSET = createField(DSL.name("remote_log_start_offset"), Domains.OFFSET_NULLABLE_T.getDataType().defaultValue(DSL.field(DSL.raw("NULL::bigint"), Domains.OFFSET_NULLABLE_T.getDataType())), this, "");

    /**
     * The column <code>logs.earliest_batch_timestamp</code>.
     */
    public final TableField<LogsRecord, Long> EARLIEST_BATCH_TIMESTAMP = createField(DSL.name("earliest_batch_timestamp"), Domains.TIMESTAMP_NULLABLE_T.getDataType(), this, "");

    /**
     * The column <code>logs.deleted_at</code>.
     */
    public final TableField<LogsRecord, Instant> DELETED_AT = createField(DSL.name("deleted_at"), SQLDataType.TIMESTAMPWITHTIMEZONE, this, "", new OffsetDateTimeToInstantConverter());
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.LOGS_BY_DELETED_AT_IDX);
    }
