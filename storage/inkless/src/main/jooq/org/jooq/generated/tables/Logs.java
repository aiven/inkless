...
public class Logs extends TableImpl<LogsRecord> {
    ...
    /**
     * The column <code>logs.consolidated_remote_log_end_offset</code>. Highest
     * offset for this partition that has been copied to tiered storage by the
     * consolidation process. NULL if none yet.
     */
    public final TableField<LogsRecord, Long> CONSOLIDATED_REMOTE_LOG_END_OFFSET = createField(DSL.name("consolidated_remote_log_end_offset"), Domains.OFFSET_NULLABLE_T.getDataType(), this, "Highest offset for this partition that has been copied to tiered storage by the consolidation process. NULL if none yet.");
