...
public class Logs extends TableImpl<LogsRecord> {
     ...
     */
    public final TableField<LogsRecord, Long> DISKLESS_START_OFFSET = createField(DSL.name("diskless_start_offset"), Domains.OFFSET_T.getDataType().nullable(false).defaultValue(DSL.field(DSL.raw("0"), Domains.OFFSET_T.getDataType())), this, "");
