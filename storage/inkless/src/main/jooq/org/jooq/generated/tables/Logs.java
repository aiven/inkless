...
public class Logs extends TableImpl<LogsRecord> {
    ...
    /**
     * The column <code>logs.diskless_end_offset</code>.
     */
    public final TableField<LogsRecord, Long> DISKLESS_END_OFFSET = createField(DSL.name("diskless_end_offset"), Domains.OFFSET_NULLABLE_T.getDataType().defaultValue(DSL.field(DSL.raw("NULL::bigint"), Domains.OFFSET_NULLABLE_T.getDataType())), this, "");

    /**
     * The column <code>logs.leader_epoch_at_init</code>.
     */
    public final TableField<LogsRecord, Integer> LEADER_EPOCH_AT_INIT = createField(DSL.name("leader_epoch_at_init"), Domains.LEADER_EPOCH_T.getDataType().nullable(false).defaultValue(DSL.field(DSL.raw("0"), Domains.LEADER_EPOCH_T.getDataType())), this, "");
