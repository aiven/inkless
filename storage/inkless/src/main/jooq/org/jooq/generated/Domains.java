...
public class Domains {
    ...
    /**
     * The domain <code>timestamp_nullable_t</code>.
     */
    public static final Domain<Long> TIMESTAMP_NULLABLE_T = Internal.createDomain(
          schema()
        , DSL.name("timestamp_nullable_t")
        , SQLDataType.BIGINT
        , Internal.createCheck(null, null, "CHECK (((VALUE IS NULL) OR (VALUE >= '-5'::integer)))")
    );
