...
BEGIN
    ...
    LOOP
        ...
        ON CONFLICT (topic_id, partition)
        DO UPDATE SET
            log_start_offset = l_request.log_start_offset,
        ...
        WHERE logs.leader_epoch_at_init < l_request.leader_epoch;
        ...
        -- Insert new producer state entries
