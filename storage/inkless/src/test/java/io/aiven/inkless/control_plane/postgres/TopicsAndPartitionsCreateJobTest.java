...
class TopicsAndPartitionsCreateJobTest {
    ...
    void createTopicsAndPartition() {
        ...
        assertThat(DBUtils.getAllLogs(pgContainer.getDataSource())).containsExactlyInAnyOrder(
            new LogsRecord(TOPIC_ID1, 0, TOPIC_1, 0L, 0L, 0L, null),
            new LogsRecord(TOPIC_ID1, 1, TOPIC_1, 0L, 0L, 0L, null),
            new LogsRecord(TOPIC_ID2, 0, TOPIC_2, 0L, 0L, 0L, null)
        );
    ...
    void createPartitionAfterTopic() {
        ...
        assertThat(DBUtils.getAllLogs(pgContainer.getDataSource())).containsExactlyInAnyOrder(
            ...
            new LogsRecord(TOPIC_ID1, 1, TOPIC_1, 0L, 0L, 0L, null),
            new LogsRecord(TOPIC_ID2, 0, TOPIC_2, 0L, 0L, 0L, null),
            new LogsRecord(TOPIC_ID2, 1, TOPIC_2, 0L, 0L, 0L, null)
        );
    }
    ...
    void existingRecordsNotAffected() throws SQLException {
        ...
        assertThat(DBUtils.getAllLogs(pgContainer.getDataSource())).containsExactlyInAnyOrder(
                new LogsRecord(TOPIC_ID1, 0, TOPIC_1, 101L, 201L, 999L, null),  // unaffected
                new LogsRecord(TOPIC_ID1, 1, TOPIC_1, 0L, 0L, 0L, null),
                new LogsRecord(TOPIC_ID2, 0, TOPIC_2, 102L, 202L, 1999L, null)  // unaffected
        );
    }
}
