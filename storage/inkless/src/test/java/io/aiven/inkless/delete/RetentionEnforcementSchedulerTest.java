...
class RetentionEnforcementSchedulerTest {
    ...
    static final BrokerMetadata BROKER_0 = new BrokerMetadata(0, Optional.empty());
    static final BrokerMetadata BROKER_1 = new BrokerMetadata(1, Optional.empty());
    static final BrokerMetadata BROKER_2 = new BrokerMetadata(2, Optional.empty());
    ...
    void intervalsDependOnBrokerCount() {
        ...
        when(metadataView.getAliveBrokers()).thenReturn(List.of(BROKER_0));
        ...
        assertThat(scheduler.dumpQueue())
            .containsExactlyInAnyOrder(
                new RetentionEnforcementScheduler.TopicIdPartitionWithLastEnforcementTime(T0P0, expectedNextTime1),
                new RetentionEnforcementScheduler.TopicIdPartitionWithLastEnforcementTime(T0P1, expectedNextTime1)
            );

        // Add the second broker.
        when(metadataView.getAliveBrokers()).thenReturn(List.of(BROKER_0, BROKER_1));
        // Sleep enough for broker count to be invalidated.
        ...
        assertThat(scheduler.dumpQueue())
            .containsExactlyInAnyOrder(
                new RetentionEnforcementScheduler.TopicIdPartitionWithLastEnforcementTime(T0P0, expectedNextTime2),
                new RetentionEnforcementScheduler.TopicIdPartitionWithLastEnforcementTime(T0P1, expectedNextTime2)
            );

        // Add the third broker.
        when(metadataView.getAliveBrokers()).thenReturn(List.of(BROKER_0, BROKER_1, BROKER_2));
        // Sleep enough for broker count to be invalidated.
        time.sleep(Duration.ofMinutes(10).toMillis());
        ...
        assertThat(scheduler.dumpQueue())
            .containsExactlyInAnyOrder(
                new RetentionEnforcementScheduler.TopicIdPartitionWithLastEnforcementTime(T0P0, expectedNextTime3),
                new RetentionEnforcementScheduler.TopicIdPartitionWithLastEnforcementTime(T0P1, expectedNextTime3)
            );

        // Reduce back to the single broker.
        when(metadataView.getAliveBrokers()).thenReturn(List.of(BROKER_2));
        // Sleep enough for broker count to be invalidated.
        time.sleep(Duration.ofMinutes(10).toMillis());
        ...
        assertThat(scheduler.dumpQueue())
            .containsExactlyInAnyOrder(
                new RetentionEnforcementScheduler.TopicIdPartitionWithLastEnforcementTime(T0P0, expectedNextTime4),
                new RetentionEnforcementScheduler.TopicIdPartitionWithLastEnforcementTime(T0P1, expectedNextTime4)
            );
    }
    ...
    void newPartitionsAreScheduled() {
        ...
        assertThat(scheduler.dumpQueue())
            .containsExactly(
                new RetentionEnforcementScheduler.TopicIdPartitionWithLastEnforcementTime(T0P1, expectedNextTime),
                new RetentionEnforcementScheduler.TopicIdPartitionWithLastEnforcementTime(T0P0, expectedNextTime)
            );
    }
