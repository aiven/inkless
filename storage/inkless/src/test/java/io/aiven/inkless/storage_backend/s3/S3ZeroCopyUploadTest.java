...
class S3ZeroCopyUploadTest {
    ...
    /**
     * Test that HeapBatchBufferData returns empty Optional.
     */
    @Test
    void uploadFromHeapByteBuffer_fallsBackToStream() {
        ...
        // Heap data should not provide a ByteBuffer (use stream instead)
        Optional<ByteBuffer> byteBuffer = heapData.asByteBuffer();
        assertThat(byteBuffer).isEmpty();
    }
