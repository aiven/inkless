...
class AvailabilityGatedControlPlaneTest {
    ...
    void availabilityReportsTheReconcilersState() {
        ...
        // Emptying the connection string is what takes the control plane out of service, and the
        // real factory then raises ControlPlaneNotConfiguredException. Without that the reconciler
        // would rebuild happily from the untouched fake config and report the control plane back in
        // service.
        factoryFailure.set(new ControlPlaneNotConfiguredException("connection.string is missing"));
