...
class AppendCompleterTest {
    ...
    void commitFinishedSuccessfully() throws Exception {
        ...
        verify(cache).put(commitBatchResponses.get(0).batchCoordinate());
        verify(cache).put(commitBatchResponses.get(2).batchCoordinate());
        verify(cache).put(commitBatchResponses.get(3).batchCoordinate());
