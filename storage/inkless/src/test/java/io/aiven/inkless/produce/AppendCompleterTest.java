...
class AppendCompleterTest {
    ...
    void commitFinishedSuccessfully() throws Exception {
        ...
        verify(cache).put(T0P0, commitBatchResponses.get(0).batchCoordinate());
        verify(cache).put(T0P1, commitBatchResponses.get(2).batchCoordinate());
        verify(cache).put(T1P0, commitBatchResponses.get(3).batchCoordinate());
