...
class CommitFileJobTest {
    ...
    void simpleCommit() {
        ...
        assertThat(DBUtils.getAllLogs(pgContainer.getDataSource()))
            .containsExactlyInAnyOrder(
                new LogsRecord(TOPIC_ID_0, 0, TOPIC_0, 0L, 0L, 0L, 0L, null, null),
                new LogsRecord(TOPIC_ID_0, 1, TOPIC_0, 0L, 15L, 100L, 0L, null, 1000L),
                new LogsRecord(TOPIC_ID_1, 0, TOPIC_1, 0L, 27L, 50L, 0L, null, time.milliseconds())
            );
    ...
    void commitMultipleFiles() {
        ...
        assertThat(DBUtils.getAllLogs(pgContainer.getDataSource()))
            .containsExactlyInAnyOrder(
                new LogsRecord(TOPIC_ID_0, 0, TOPIC_0, 0L, 159L, 111L, 0L, null, 3000L),
                new LogsRecord(TOPIC_ID_0, 1, TOPIC_0, 0L, 15L + 245, 322L, 0L, null, 1000L),
                new LogsRecord(TOPIC_ID_1, 0, TOPIC_1, 0L, 27L, 50L, 0L, null, firstFileCommittedAt)
            );
    ...
    void inSequenceCommit() {
        ...
        assertThat(DBUtils.getAllLogs(pgContainer.getDataSource()))
            .containsExactlyInAnyOrder(
                new LogsRecord(TOPIC_ID_0, 0, TOPIC_0, 0L, 0L, 0L, 0L, null, null),
                new LogsRecord(TOPIC_ID_0, 1, TOPIC_0, 0L, 27L, 150L, 0L, null, 1000L),
                new LogsRecord(TOPIC_ID_1, 0, TOPIC_1, 0L, 0L, 0L, 0L, null, null)
            );
    ...
    void outOfOrderCommitNewEpoch() {
        ...
        assertThat(DBUtils.getAllLogs(pgContainer.getDataSource()))
            .containsExactlyInAnyOrder(
                new LogsRecord(TOPIC_ID_0, 0, TOPIC_0, 0L, 0L, 0L, 0L, null, null),
                new LogsRecord(TOPIC_ID_0, 1, TOPIC_0, 0L, 0L, 0L, 0L, null, null),
                new LogsRecord(TOPIC_ID_1, 0, TOPIC_1, 0L, 0L, 0L, 0L, null, null)
            );
