...
public class PartitionRegistration {
    ...
    public static class Builder {
        ...
        private long firstDisklessOffset = -1L;
        ...
        public Builder setFirstDisklessOffset(long firstDisklessOffset) {
            this.firstDisklessOffset = firstDisklessOffset;
            return this;
        }

        public Builder setDisklessProducerStates(List<InitDisklessLogFields.ProducerStateEntry> disklessProducerStates) {
            this.disklessProducerStates = disklessProducerStates;
            return this;
        }
    ...
    public static final long UNSET_FIRST_DISKLESS_OFFSET = -1L;
    ...
    public final long firstDisklessOffset;
    ...
    public PartitionRegistration(PartitionRecord record) {
        this(Replicas.toArray(record.replicas()),
            ...
            InitDisklessLogFields.decodeFirstDisklessOffset(record.unknownTaggedFields()),
    ...
    public PartitionRegistration merge(PartitionChangeRecord record) {
        ...
        long newFirstDisklessOffset = InitDisklessLogFields.decodeFirstDisklessOffset(record.unknownTaggedFields());
        List<InitDisklessLogFields.ProducerStateEntry> newDisklessProducerStates =
            InitDisklessLogFields.decodeProducerStates(record.unknownTaggedFields());
        if (newFirstDisklessOffset == UNSET_FIRST_DISKLESS_OFFSET) {
            newFirstDisklessOffset = firstDisklessOffset;
        ...
        return new PartitionRegistration(newReplicas,
            ...
            newElr,
            newLastKnownElr,
            newFirstDisklessOffset,
            newDisklessProducerStates);
    }

    public PartitionRegistration withFirstDisklessOffset(long firstDisklessOffset) {
        return new PartitionRegistration(replicas, directories, isr, removingReplicas,
            ...
            elr, lastKnownElr, firstDisklessOffset, disklessProducerStates);
    }
    ...
    public String diff(PartitionRegistration prev) {
        ...
        if (firstDisklessOffset != prev.firstDisklessOffset) {
            builder.append(prefix).append("firstDisklessOffset: ").
                append(prev.firstDisklessOffset).append(" -> ").append(firstDisklessOffset);
            prefix = ", ";
        }
    ...
    public ApiMessageAndVersion toRecord(Uuid topicId, int partitionId, ImageWriterOptions options) {
        ...
        if (firstDisklessOffset != UNSET_FIRST_DISKLESS_OFFSET) {
            record.unknownTaggedFields().add(
                InitDisklessLogFields.encodeFirstDisklessOffset(firstDisklessOffset));
    ...
    public int hashCode() {
        return Objects.hash(Arrays.hashCode(replicas), Arrays.hashCode(isr), Arrays.hashCode(removingReplicas),
            ...
            firstDisklessOffset, disklessProducerStates);
    }
    ...
    public boolean equals(Object o) {
        ...
        return Arrays.equals(replicas, other.replicas) &&
            ...
            firstDisklessOffset == other.firstDisklessOffset &&
    ...
    public String toString() {
        return "PartitionRegistration(" + "replicas=" + Arrays.toString(replicas) +
                ...
                ", firstDisklessOffset=" + firstDisklessOffset +
