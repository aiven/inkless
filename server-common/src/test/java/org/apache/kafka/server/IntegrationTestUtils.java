...
public class IntegrationTestUtils {
    ...
    public static <T extends AbstractResponse> T receive(Socket socket, ApiKeys apiKey, short version) throws IOException {
    ...
    public static <T extends AbstractResponse> T sendAndReceive(
        ...
        RequestHeader header = nextRequestHeader(request.apiKey(), request.version());
