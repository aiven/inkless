...
public class ServerConfigs {
    ...
    public static final String DISKLESS_CONSOLIDATION_FETCH_MAX_BYTES_DOC = "The maximum number of bytes per partition the consolidation " +
        "fetcher will request per iteration. Larger values allow fetching more batches per iteration, reducing PG query frequency. " +
        "Defaults to 10MB (vs replica.fetch.max.bytes=1MB) since consolidation reads sequentially and benefits from larger fetches.";
