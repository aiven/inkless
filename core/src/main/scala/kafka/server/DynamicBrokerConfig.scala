...
object DynamicBrokerConfig {
  ...
  val AllDynamicConfigs = DynamicSecurityConfigs ++
    ...
    Set(ServerConfigs.DISKLESS_CONTROL_PLANE_AVAILABILITY_CONFIG)
...
class DynamicDisklessControlPlaneConfig(availability: ControlPlaneAvailability) extends BrokerReconfigurable {
  ...
  override def reconfigurableConfigs: Set[String] = Set(ServerConfigs.DISKLESS_CONTROL_PLANE_AVAILABILITY_CONFIG)
