...
class LogConfigTest {
  ...
  def testDisklessConfigsAtUpdate(): Unit = {
    ...
    val inklessAlreadyEnabled = util.Map.of(TopicConfig.INKLESS_ENABLE_CONFIG, "true")
    val disklessAlreadyEnabled = util.Map.of(TopicConfig.DISKLESS_ENABLE_CONFIG, "true")
    val inklessAndDisklessAlreadyEnabled = util.Map.of(TopicConfig.INKLESS_ENABLE_CONFIG, "true", TopicConfig.DISKLESS_ENABLE_CONFIG, "true")
    val inklessAlreadyDisabled = util.Map.of(TopicConfig.INKLESS_ENABLE_CONFIG, "false")
    val disklessAlreadyDisabled = util.Map.of(TopicConfig.DISKLESS_ENABLE_CONFIG, "false")
    val inklessAndDisklessAlreadyDisabled = util.Map.of(TopicConfig.INKLESS_ENABLE_CONFIG, "false", TopicConfig.DISKLESS_ENABLE_CONFIG, "false")
