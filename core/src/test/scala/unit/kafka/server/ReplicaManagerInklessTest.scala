...
import org.apache.kafka.common.{Node, IsolationLevel, TopicIdPartition, TopicPartition, Uuid}
...
class ReplicaManagerInklessTest {
  ...
  private def partitionRegistration(leader: Int,
    ...
    new LeaderAndIsrRequest.PartitionState()
      ...
      .setIsr(java.util.Arrays.asList(isr.map(Integer.valueOf): _*))
      .setPartitionEpoch(partitionEpoch)
      .setReplicas(java.util.Arrays.asList(replicas.map(Integer.valueOf): _*))
  }
