...
class KafkaApisTest extends Logging {
  ...
  private val topicMirrorLinkCoordinator: ClusterMirrorCoordinator = mock(classOf[ClusterMirrorCoordinator])
  ...
  private val quotas = new QuotaManagers(clientQuotaManager, clientQuotaManager, clientRequestQuotaManager,
    clientControllerQuotaManager, replicaQuotaManager, replicaQuotaManager, replicaQuotaManager, replicaQuotaManager, replicaQuotaManager, util.Optional.empty())
  ...
  def createKafkaApis(
    ...
    new KafkaApis(
      ...
      clusterMirrorCoordinator = topicMirrorLinkCoordinator,
