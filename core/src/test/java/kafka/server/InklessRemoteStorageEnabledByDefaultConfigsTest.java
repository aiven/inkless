...
public class InklessRemoteStorageEnabledByDefaultConfigsTest {
    ...
    class IncrementalAlterConfigs {
        @Test
        void alteringConfigOfClassicTieredTopicReturnsError() throws Exception {
            // Given a cluster
            var cluster = init();
            Map<String, Object> clientConfigs = new HashMap<>();
            clientConfigs.put(CommonClientConfigs.BOOTSTRAP_SERVERS_CONFIG, cluster.bootstrapServers());
            ...
            try (Admin admin = AdminClient.create(clientConfigs)) {
                // Given a classic tiered topic
                String topicName = "classicTopic";
                createTopic(admin, topicName, Map.of(REMOTE_LOG_STORAGE_ENABLE_CONFIG, "true"));
        ...
        @Test
        void deletingConfigsOfClassicTieredTopicReturnsError() throws Exception {
            // Given a cluster
            var cluster = init();
            Map<String, Object> clientConfigs = new HashMap<>();
            clientConfigs.put(CommonClientConfigs.BOOTSTRAP_SERVERS_CONFIG, cluster.bootstrapServers());
    ...
    private KafkaClusterTestKit init() throws Exception {
